...
cp -r $GITHUB_WORKSPACE/source/video/NetworkWorld1.mp4 ./feeds/luci/themes/luci-theme-argon-mod/htdocs/luci-static/argon/background
cp -r $GITHUB_WORKSPACE/source/video/NetworkWorld2.mp4 ./feeds/luci/themes/luci-theme-argon-mod/htdocs/luci-static/argon/background
cp -r $GITHUB_WORKSPACE/source/video/NetworkWorld3.mp4 ./feeds/luci/themes/luci-theme-argon-mod/htdocs/luci-static/argon/background
cp -r $GITHUB_WORKSPACE/source/video/video1.mp4 ./feeds/luci/themes/luci-theme-argon-mod/htdocs/luci-static/argon/background
cp -r $GITHUB_WORKSPACE/source/video/video2.mp4 ./feeds/luci/themes/luci-theme-argon-mod/htdocs/luci-static/argon/background
cp -r $GITHUB_WORKSPACE/source/video/video3.mp4 ./feeds/luci/themes/luci-theme-argon-mod/htdocs/luci-static/argon/background
cp -r $GITHUB_WORKSPACE/source/img/1.jpg ./feeds/luci/themes/luci-theme-argon-mod/htdocs/luci-static/argon/background
